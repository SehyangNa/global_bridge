...
export const ui = {
  ko: {
    ...
    formIntro: '국가, 목적, 산업, 긴급도를 선택하세요. 이 MVP는 모의 공공데이터 신호와 투명한 점수 조정을 사용하며 실시간 API 데이터는 가져오지 않습니다.',
    ...
    transparency: '이 MVP는 공식 공공데이터 API가 비즈니스 리스크 브리핑을 어떻게 지원할 수 있는지 보여주기 위해 모의 공공데이터 신호를 사용합니다. 아직 실시간 데이터는 가져오지 않습니다.',
    ...
    generated: '생성된 브리핑', generatedPlaceholder: '선택한 조건과 모의 공공데이터 신호 요약을 포함한 간결한 경영진용 브리핑을 생성합니다.',
  },
  en: {
    ...
    formIntro: 'Select the country, purpose, industry, and urgency. The MVP uses mock public-data signals and transparent scoring adjustments. No live API data is fetched.',
    ...
    transparency: 'This MVP uses mock public-data signals to demonstrate how official public data APIs can support business risk briefings. It does not yet fetch live data.',
    ...
    generated: 'Generated briefing', generatedPlaceholder: 'Generate a compact executive briefing that includes the selected context and mock public-data signal summary.',
  },
}
