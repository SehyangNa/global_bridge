...
export const ui = {
  ko: {
    ...
    liveAvailabilityNote: '실시간 외교부 안전정보를 사용할 수 있을 때 우선 표시합니다. 사용할 수 없으면 MVP 모의 공공데이터 신호를 표시합니다.',
    liveFallbackNote: '현재 실시간 외교부 안전정보를 불러올 수 없어 MVP 모의 공공데이터 신호를 표시합니다.',
  ...
  en: {
    ...
    liveAvailabilityNote: 'Live MOFA safety data is used when available. Otherwise, MVP mock public-data signals are shown.',
    liveFallbackNote: 'Live MOFA safety data is currently unavailable, so MVP mock public-data signals are shown.',
