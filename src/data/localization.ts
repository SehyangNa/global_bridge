...
export const ui = {
  ko: {
    ...
    countryHelper: '분석할 대상 국가를 선택하세요.', purposeHelper: '출장·교역·투자 목적을 반영합니다.', industryHelper: '산업별 노출 요인을 점수에 반영합니다.', urgencyHelper: '의사결정 시급성을 종합 점수에 반영합니다.',
    ...
    generated: '생성된 브리핑', generatedPlaceholder: '선택한 조건과 공공데이터 신호만 근거로 간결한 경영진용 브리핑을 생성합니다.',
    generating: '브리핑 생성 중…', generatingBriefing: '선택한 리스크와 공공데이터 신호를 바탕으로 브리핑을 작성하고 있습니다.',
    generationMode: '생성 방식', aiGenerated: 'AI 생성', templateFallback: '기본 브리핑',
  ...
  en: {
    ...
    countryHelper: 'Choose the country you want to assess.', purposeHelper: 'Applies travel, trade, or investment context.', industryHelper: 'Adjusts scores for industry-specific exposure.', urgencyHelper: 'Reflects decision urgency in the overall score.',
    ...
    generated: 'Generated briefing', generatedPlaceholder: 'Generate a compact executive briefing grounded only in the selected context and public-data signals.',
    generating: 'Generating briefing…', generatingBriefing: 'Preparing a briefing from the selected risks and public-data signals.',
    generationMode: 'Generation mode', aiGenerated: 'AI generated', templateFallback: 'Template fallback',
