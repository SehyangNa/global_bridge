...
export const ui = {
  ko: {
    ...
    riskDashboard: '리스크 인텔리전스 대시보드', overallSnapshot: '종합 리스크 스냅샷', nowActions: '지금 해야 할 행동',
    overallLevel: '종합 리스크 수준', overallScore: '종합 점수', urgencyAdjustment: '긴급도 조정', categoryScores: '리스크 카테고리 점수',
    ...
    mockData: 'MVP 모의 데이터',
    dataCoverage: '데이터 커버리지', coverageLive: '실시간', coverageArchived: '과거 데이터', coverageMock: 'MVP 모의 신호', coverageUnavailable: '사용 불가',
    limitedDataDisclosure: '선택한 국가와 직접 관련된 최신 공공데이터가 부족하여, 과거 공공데이터와 MVP 모의 신호를 함께 사용했습니다.',
    sourceFallbackNote: '이 출처의 최신 신호가 부족해 관련 MVP 모의 신호로 보완했습니다.',
    aiFallbackDisclosure: 'AI 브리핑은 제공된 공공데이터 신호와 MVP 모의 신호를 기반으로 생성되었습니다.',
  ...
  en: {
    ...
    riskDashboard: 'Risk Intelligence Dashboard', overallSnapshot: 'Overall Risk Snapshot', nowActions: 'Recommended Actions',
    ...
    dataCoverage: 'Data Coverage', coverageLive: 'Live', coverageArchived: 'Archived', coverageMock: 'MVP mock', coverageUnavailable: 'Unavailable',
    limitedDataDisclosure: 'Recent country-specific public data is limited, so archived public data and MVP mock signals are used together.',
    sourceFallbackNote: 'Recent signals from this source are limited, so relevant MVP mock signals supplement the dashboard.',
    aiFallbackDisclosure: 'The AI briefing was generated from the provided public data signals and MVP mock signals.',
